%% Parameter estimation of the coarse grained model
% presented in Fig. 2b
...
[ps_opt,resnorm,residual,exitflag,output,lambda,jacobian] = ...
    lsqnonlin(@(ps) diff_model_impulse(ps, data_xray, ps_order, ps_name), ps_give, lb, ub, opts);
save('params/coarse_grained.mat', 'ps_give', 'ps_order', 'ps_name', 'ps_opt', 'lb', 'ub', '-append');
